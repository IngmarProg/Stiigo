...
begin
  ...
  begin
    ...
    TmpBitmap:=LoadBitmapFromTyphonResource('prev2');
    Glyph := TmpBitmap;
  ...
  with FBtns[1] do begin
    ...
    TmpBitmap:=LoadBitmapFromTyphonResource('prev1');
    Glyph := TmpBitmap;
    FreeAndNil(TmpBitmap);
  ...
  begin
    ...
    TmpBitmap:=LoadBitmapFromTyphonResource('next1');
    Glyph := TmpBitmap;
    FreeAndNil(TmpBitmap);
  ...
  with FBtns[3] do begin
    ...
    TmpBitmap:=LoadBitmapFromTyphonResource('next2');
    Glyph := TmpBitmap;
    FreeAndNil(TmpBitmap);
