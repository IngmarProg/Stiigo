...
type
  // 29.05.2011 Ingmar
  TOnLookupTitleColClick = procedure(column : tcolumn) of object;
  ...
  private
    ...
    FOwner:TPersistent;
    FOnLookupTitleColClick :TOnLookupTitleColClick;
  ...
  published
    ...
    property OnLookupTitleColClick : TOnLookupTitleColClick read FOnLookupTitleColClick write  FOnLookupTitleColClick;
  end;
...
{$ENDIF}
  ...
  FGrid.BorderStyle:=FPopUpFormOptions.BorderStyle;
    // 29.05.2011 Ingmar
  FGrid.OnTitleClick:=FPopUpFormOptions.OnLookupTitleColClick;
