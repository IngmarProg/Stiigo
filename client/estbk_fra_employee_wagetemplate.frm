object frameEmpwageTypeDefTemplate: TframeEmpwageTypeDefTemplate
  Left = 0
  Height = 500
  Top = 0
  Width = 700
  ...
  object grpContract: TGroupBox
    ...
    object gridSalaryTemplate: TStringGrid
      Left = 6
      Height = 409
      Top = 4
      Width = 666
      ...
      Columns = <      
        item
          Color = cl3DLight
          ReadOnly = True
          Title.Caption = 'Rea kood'
          Width = 55
        end      
        item
          Title.Caption = 'Rea liik'
          Width = 155
        end      
        item
          Title.Caption = 'Konto'
      ...
      TabOrder = 1
      TitleStyle = tsNative
      OnDrawCell = gridSalaryTemplateDrawCell
      OnEditingDone = gridSalaryTemplateEditingDone
      OnKeyDown = gridSalaryTemplateKeyDown
      OnKeyPress = gridSalaryTemplateKeyPress
      OnPrepareCanvas = gridSalaryTemplatePrepareCanvas
      OnSelectEditor = gridSalaryTemplateSelectEditor
    end
  end
  ...
  object qryRowltype: TZReadOnlyQuery
    Params = <>
    left = 504
    top = 8
  end
  ...
  object qryRowltypeDs: TDatasource
    AutoEdit = False
    DataSet = qryRowltype
    left = 504
    top = 72
  ...
  object qryTemp: TZReadOnlyQuery
    Params = <>
    left = 432
    top = 8
  end
