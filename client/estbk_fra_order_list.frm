object frameOrderList: TframeOrderList
  Left = 0
  Height = 433
  Top = 0
  Width = 699
  ...
  object grpBoxObjects: TGroupBox
    ...
    object lblOrderDate: TLabel
      ...
      Alignment = taRightJustify
      AutoSize = False
      Caption = 'Tellimuse kuupäev:'
      Font.Style = [fsBold]
      ParentColor = False
      ParentFont = False
    end
    object dtEdtAccDateStart: TDateEdit
      Left = 119
      Height = 21
      Top = 30
      Width = 95
    ...
    object chkbxOnlyOverdueBills: TCheckBox
      Left = 119
      Height = 17
      Top = 124
      Width = 138
      Caption = 'Koostatud lõplik arve'
      OnKeyPress = edtClientCodeKeyPress
      TabOrder = 7
    end
    ...
    object dtEdtAccDateEnd: TDateEdit
      Left = 245
      Height = 21
      Top = 30
      Width = 95
  ...
  object parentPanel: TPanel
    ...
    object ordersGrid: TDBGrid
      ...
      Columns = <      
        item
          Title.Caption = 'Tellimuse nr'
          Width = 85
          FieldName = 'order_nr'
        end      
        item
          Title.Caption = 'Tellimuse kp.'
          Width = 70
        ...
        item
          Title.Caption = 'Tellimuse esitas'
          Width = 195
          FieldName = 'lastname'
        end      
        item
          Title.Caption = 'Tellimuse täitja'
          Width = 195
          FieldName = 'lastname'
        end>
      DataSource = qryOrderListDs
      Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgCancelOnExit]
      ReadOnly = True
      TabOrder = 0
      TitleStyle = tsNative
      OnDrawColumnCell = ordersGridDrawColumnCell
      OnDblClick = ordersGridDblClick
      OnKeyPress = ordersGridKeyPress
      OnPrepareCanvas = ordersGridPrepareCanvas
    end
  end
  ...
  object qryOrderList: TZQuery
    Params = <>
    left = 344
    top = 8
  end
  object qryOrderListDs: TDatasource
