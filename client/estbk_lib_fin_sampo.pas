...
type
  ...
  public
    class function ReadCamt053Short(const pStream: TStringStream; const pColl: TCollection): boolean;
    // pole vaja; eelmine funktsioon oskab lugeda camt 052 ja camt 053
    class function ReadCamt053Full(const pStream: TStringStream; const pColl: TCollection): boolean;
    // deprecated
  end;
  ...
  TFI_camt_052 = class
  public
    class function Read(const pStream: TStringStream; var pdtStart: TDatetime; var pdtEnd: TDatetime;
      var pOpeningBal: double; var pClosingBal: double; var pError: Astr): boolean;
  end;
...
class function TFI_camt_053.ReadCamt053Short(const pStream: TStringStream; const pColl: TCollection): boolean;
const
  ...
  try
    ...
    begin
      ...
      begin
        ...
        else if pIterator.NodeName = 'Ntry' then
        begin
          ...
          if Assigned(dt) then
            pcItem.FBookingDateStr := readNodeCont(Dt.FindNode('Dt'));
          ...
          pcItem.FTransactionId := readNodeCont(pIterator.FindNode('AcctSvcrRef'));
          // The account servicing institution's reference for the transaction (kreediti puhul maksja konto ?).
...
class function TFI_camt_053.ReadCamt053Full(const pStream: TStringStream; const pColl: TCollection): boolean;
var
  Doc: TXMLDocument;
...
class function TFI_camt_052.Read(const pStream: TStringStream; var pdtStart: TDatetime; var pdtEnd: TDatetime;
  var pOpeningBal: double; var pClosingBal: double; var pError: Astr): boolean;
var
  Doc: TXMLDocument;
  Root, BkToCstmrAcctRpt, GrpHdr, FrToDt, pDtIter, FrDtTm, ToDtTm, Rpt, OpeningBalance, ClosingBalance, pIterator, Bal, Amt: TDomNode;
