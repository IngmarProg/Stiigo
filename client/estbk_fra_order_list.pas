...
type
  ...
  TframeOrderList = class(Tfra_template)
    ...
    procedure ordersGridDrawColumnCell(Sender: TObject; const Rect: TRect;
      DataCol: Integer; Column: TColumn; State: TGridDrawState);
    procedure ordersGridKeyPress(Sender: TObject; var Key: char);
    procedure ordersGridPrepareCanvas(sender: TObject; DataCol: Integer;
...
if cmbOrderType.ItemIndex>=0 then
   ...
   qryOrderList.SQL.add(estbk_sqlclientcollection._SQLSrcOrders(pOrdType,
                                                                pOrdStatus,
                                                                self.FLastclientID,
                                                                pOrdNr,
                                                                pdtStart,
...
procedure TframeOrderList.edtClientCodeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TframeOrderList.ordersGridDrawColumnCell(Sender: TObject;
...
procedure TframeOrderList.ordersGridPrepareCanvas(sender: TObject;
