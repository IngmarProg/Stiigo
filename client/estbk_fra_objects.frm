object frameObjects: TframeObjects
  Tag = -1
  Left = 0
  Height = 434
  Top = 0
  ...
  object grpBoxObjects: TGroupBox
    ...
    object grpObjType: TComboBox
      ...
      AutoDropDown = True
      ItemHeight = 13
      OnChange = grpObjTypeChange
      OnExit = grpObjTypeExit
      OnKeyPress = grpObjTypeKeyPress
      ParentFont = False
      TabOrder = 0
    end
    object lblObjNimi: TLabel
      Left = 347
      Height = 15
      Top = 14
      Width = 119
  ...
  object pgrpPanel: TPanel
    ...
    object panelLogSeparator: TPanel
      Left = 3
      Height = 39
      Top = 3
      Width = 674
      ...
      ParentFont = False
      TabOrder = 1
      object edtSearchObject: TEdit
        Left = 468
        Height = 21
        Top = 10
        Width = 203
        OnKeyPress = edtSearchObjectKeyPress
        ParentFont = False
        TabOrder = 0
      end
      object lblSearch: TLabel
        ...
        Alignment = taRightJustify
        AutoSize = False
        Caption = 'Otsi nimetust:'
        ParentColor = False
        ParentFont = False
      end
      object cmbFilterByGrp: TComboBox
        Left = 133
        Height = 21
        Top = 10
        Width = 208
        ItemHeight = 13
        OnChange = cmbFilterByGrpChange
        OnKeyPress = grpObjTypeKeyPress
        ParentFont = False
        Style = csDropDownList
        TabOrder = 1
      end
      object lblFilt: TLabel
        Left = 7
        Height = 16
        Top = 13
        Width = 126
  ...
  object qryObjects: TZQuery
    ...
    BeforeScroll = qryObjectsBeforeScroll
    AfterScroll = qryObjectsAfterScroll
    UpdateObject = qryObjInsUpt
    CachedUpdates = True
    AfterInsert = qryObjectsAfterEdit
    AfterEdit = qryObjectsAfterEdit
    BeforePost = qryObjectsBeforePost
    AfterPost = qryObjectsAfterPost
    AfterCancel = qryObjectsAfterScroll
    Params = <>
    Sequence = qryObjSeq
    left = 416
    top = 288
  end
  object qryObjDs: TDatasource
    DataSet = qryObjects
    left = 208
    top = 288
  end
  object qryObjTypesMisc: TZQuery
    AutoCalcFields = False
    Params = <>
    left = 64
    top = 288
  end
  object qryObjInsUpt: TZUpdateSQL
    UseSequenceFieldForRefreshSQL = True
    left = 352
    top = 288
  end
  object qryObjSeq: TZSequence
    left = 136
    top = 288
  end
  object qryObjTypesSeq: TZSequence
    left = 272
    top = 288
  end
end
