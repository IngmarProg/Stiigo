...
type
  TStsIndex = (
                    ...
                    // -- välimus
                    Csts_forms_as_sdi = 23, // enamasti on programm MDI reziimis multi document interface; mõnikord SDI on parem single document interface
...
begin
  ...
  FUserColors[uvc_itemTypeAsBillColor]:=pGetColor(Csts_vis_itemTypeAsBillColor,ClInfobk); // arve ridu kuvatakse sellise värviga; maksekorraldus / laekumised
  FUserColors[uvc_itemTypeAsOrderColor]:=pGetColor(Csts_vis_itemTypeAsOrderColor,estbk_types.MyFavYellowGreen);  // tellimuse ridu kuvatakse sellise värviga; maksekorraldus / laekumised
