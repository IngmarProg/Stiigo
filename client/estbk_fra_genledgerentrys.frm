object frameGenLedgerEntrys: TframeGenLedgerEntrys
  Left = 0
  Height = 434
  Top = 0
  Width = 800
  ...
  DesignLeft = 275
  DesignTop = 275
  object grpBoxAccEntrys: TGroupBox
    Left = 8
    Height = 136
    Top = 2
    Width = 789
    Anchors = [akTop, akLeft, akRight]
    Caption = ' Kannete nimekiri'
    ClientHeight = 118
    ClientWidth = 785
    Font.Style = [fsBold]
    ParentFont = False
    TabOrder = 0
    object lblEdtEntrynr: TLabeledEdit
      Left = 86
      Height = 21
      Top = 7
      Width = 120
      EditLabel.AnchorSideLeft.Control = lblEdtEntrynr
      EditLabel.AnchorSideLeft.Side = asrBottom
      EditLabel.AnchorSideTop.Control = lblEdtEntrynr
      EditLabel.AnchorSideTop.Side = asrCenter
      EditLabel.AnchorSideRight.Control = lblEdtEntrynr
      EditLabel.AnchorSideBottom.Control = lblEdtEntrynr
      EditLabel.Left = 29
      EditLabel.Height = 14
      EditLabel.Top = 10
      EditLabel.Width = 54
      EditLabel.Caption = 'Kande nr:'
      EditLabel.ParentColor = False
      LabelPosition = lpLeft
      ParentFont = False
      TabOrder = 0
      OnKeyPress = lblEdtEntrynrKeyPress
    end
    object ldlEdtDescr: TLabeledEdit
      Left = 286
      Height = 21
      Top = 30
      Width = 354
      EditLabel.AnchorSideLeft.Control = ldlEdtDescr
      EditLabel.AnchorSideTop.Control = ldlEdtDescr
      EditLabel.AnchorSideTop.Side = asrCenter
      EditLabel.AnchorSideRight.Control = ldlEdtDescr
      EditLabel.AnchorSideBottom.Control = ldlEdtDescr
      EditLabel.Left = 230
      EditLabel.Height = 14
      EditLabel.Top = 33
      EditLabel.Width = 53
      EditLabel.Caption = 'Kirjeldus:'
      EditLabel.ParentColor = False
      LabelPosition = lpLeft
      ParentFont = False
      TabOrder = 4
    ...
    object lblEdtDocNr: TLabeledEdit
      Left = 86
      Height = 21
      Top = 30
      Width = 120
      EditLabel.AnchorSideLeft.Control = lblEdtDocNr
      EditLabel.AnchorSideTop.Control = lblEdtDocNr
      EditLabel.AnchorSideTop.Side = asrCenter
      EditLabel.AnchorSideRight.Control = lblEdtDocNr
      EditLabel.AnchorSideBottom.Control = lblEdtDocNr
      EditLabel.Left = 39
      EditLabel.Height = 14
      EditLabel.Top = 33
      EditLabel.Width = 44
      EditLabel.Caption = 'Dok. nr:'
      EditLabel.ParentColor = False
      LabelPosition = lpLeft
      ParentFont = False
      TabOrder = 3
  ...
  object pmainPanel: TPanel
    ...
    object accEntrys: TDBGrid
      ...
      Columns = <      
        ...
        item
          Title.Caption = 'Majandusaasta'
          Width = 95
          FieldName = 'apname'
        end>
      DataSource = qryAccEntrysds
      ...
      OnDblClick = accEntrysDblClick
      OnKeyPress = accEntrysKeyPress
      OnPrepareCanvas = accEntrysPrepareCanvas
    end
  end
  object qryAccEntrys: TZQuery
  ...
  object qryAccEntrysds: TDatasource
    DataSet = qryAccEntrys
    left = 648
    top = 144
  end
end
