...
begin
  ...
  begin
    case Index of
      sw_off: begin
                FBitmaps[Index].LoadFromResourceName(Hinstance,'RXSWITCH_OFF');
                FBitmaps[Index].TransparentColor:=clFuchsia;
                FBitmaps[Index].Transparent:=true;
              end;
      sw_on:  begin
                FBitmaps[Index].LoadFromResourceName(Hinstance,'RXSWITCH_ON');
                FBitmaps[Index].TransparentColor:=clFuchsia;
                FBitmaps[Index].Transparent:=true;
              end;
    end;
