...
begin
  if FBitmap = nil then FBitmap := TBitmap.Create;
   ...
   case FValue of
    1:FBitmap.LoadFromResourceName(Hinstance,'DICE1');
    2:FBitmap.LoadFromResourceName(Hinstance,'DICE2');
    3:FBitmap.LoadFromResourceName(Hinstance,'DICE3');
    4:FBitmap.LoadFromResourceName(Hinstance,'DICE4');
    5:FBitmap.LoadFromResourceName(Hinstance,'DICE5');
    6:FBitmap.LoadFromResourceName(Hinstance,'DICE6');
  end;
